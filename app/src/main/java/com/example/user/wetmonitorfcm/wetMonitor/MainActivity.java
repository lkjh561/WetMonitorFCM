...
import com.example.user.wetmonitorfcm.R;
import com.example.user.wetmonitorfcm.dbcontrol.BleDevice;
import com.example.user.wetmonitorfcm.dbcontrol.DBcontract;
import com.example.user.wetmonitorfcm.dbcontrol.PushDevice;
import com.example.user.wetmonitorfcm.dbcontrol.TorkenDBhelper;
...
public class MainActivity extends ListActivity implements BeaconConsumer {
    ...
    private com.example.user.wetmonitorfcm.wetMonitor.DeviceListAdapter mDevicesListAdapter = null;
    static com.example.user.wetmonitorfcm.wetMonitor.RegistListAdapter mRegistListAdapter = null;
    ...
    com.example.user.wetmonitorfcm.wetMonitor.Sendtask sendtask = null;
    ...
    protected void onResume() {
        ...
        mDevicesListAdapter = new com.example.user.wetmonitorfcm.wetMonitor.DeviceListAdapter(this);
        mRegistListAdapter = new com.example.user.wetmonitorfcm.wetMonitor.RegistListAdapter(this);
